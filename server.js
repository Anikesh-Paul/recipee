...
const rawAppwriteEndpoint =
  process.env.VITE_APPWRITE_ENDPOINT || process.env.APPWRITE_ENDPOINT || "";
const rawAppwriteName =
  process.env.VITE_APPWRITE_PROJECT_NAME ||
...
console.log("Appwrite config:", {
  projectId: APPWRITE.projectId
    ? `${APPWRITE.projectId.substring(0, 6)}...`
    : "(not set)",
...
let recipes = [
  {
    ...
    instructions:
      "Cook pasta. Fry pancetta. Mix eggs and cheese. Combine all with a splash of pasta water.",
    image:
  ...
  },
  {
    ...
    description:
      "Perfectly ripe avocado on toasted sourdough with chili flakes and a drizzle of olive oil.",
    ingredients: [
    ...
    instructions:
      "Toast the bread. Mash avocado with lemon and salt. Spread on toast. Garnish with chili and oil.",
    image:
  ...
  },
  {
    ...
    description:
      "An aromatic and spicy curry with coconut milk, authentic Thai herbs, and fresh vegetables.",
    ingredients: [
      "400ml coconut milk",
    ...
    instructions:
      "Simmer curry paste with coconut milk. Add protein and vegetables. Season with fish sauce and basil.",
    image:
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a helpful culinary assistant for Alimenta, a minimalist recipe archive. Provide concise, high-fidelity culinary advice.",
          },
